...
for i in range(40):
    spillbrett.make_hand("stein", randint(0, 1050), randint(0, 650))
    spillbrett.make_hand("saks", randint(0, 1050), randint(0, 650))
    spillbrett.make_hand("papir", randint(0, 1050), randint(0, 650))
